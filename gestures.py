...
class Gestures:
    ...
    def number_to_gesture(self):
        ...
        elif number_to_name == 1:
            print(" The computer has chosen Spock!")
        elif number_to_name == 2:
            print(" The computer has chosen Paper!")
        elif number_to_name == 3:
            print(" The computer has chosen Lizard!")
        elif number_to_name == 4:
